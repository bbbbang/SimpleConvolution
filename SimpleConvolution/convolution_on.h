...
void _Convolution2D_k3_s1(Tensor* tensor, float* weight, float* bias, int inChannel, int outChannel, int kernel = 3, int stride = 1, int padding = 1)
{
}

void _Convolution2D_k3_s2(Tensor* tensor, float* weight, float* bias, int inChannel, int outChannel, int kernel = 3, int stride = 2, int padding = 1)
{
...
void _Convolution2D_Depthwise_k3_s1(Tensor* tensor, float* weight, float* bias, int inChannel, int outChannel, int kernel = 3, int stride = 1, int padding = 1)
{
	int height = tensor->height;
	int width = tensor->width;
	int channel = tensor->channel;
...
void _Convolution2D_Depthwise_k3_s2(Tensor* tensor, float* weight, float* bias, int inChannel, int outChannel, int kernel = 3, int stride = 2, int padding = 1)
{
	int height = tensor->height;
	int width = tensor->width;
	int channel = tensor->channel;
...
void _Convolution2D_Pointwise_k1_s1(Tensor* tensor, float* weight, float* bias, int inChannel, int outChannel, int kernel = 1, int stride = 1, int padding = 0)
{
	int height = tensor->height;
	int width = tensor->width;
	int channel = tensor->channel;
